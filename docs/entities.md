...
- `code`: Номер документа с префиксом `P-` (например, `P-1`). Генерируется автоматически.
...
- `code`: Номер документа с префиксом `S-` (например, `S-1`). Генерируется автоматически.
...
- `code`: Номер документа с префиксом `R-` (например, `R-1`). Генерируется автоматически.
...
- `code`: Номер документа с префиксом `A-` (например, `A-1`). Генерируется автоматически.
...
- `code`: Номер документа с префиксом `T-` (например, `T-1`). Генерируется автоматически.
...
- `code`: Номер документа с префиксом `PC-` (например, `PC-1`). Генерируется автоматически.

...
*   **Важно**: Снимки `quantityBefore` и `quantityAfter` фиксируются именно в момент проведения (completion), а не в момент создания черновика. Это гарантирует актуальность данных в акте.
